function NavDropdownNike() {
  return (
    <div
      id="ChildNikeShoes"
      className="w-[70%] absolute after:absolute after:top-[58px] after:left-[-11px] after:content-[''] after:block  after:w-10 after:h-10  top-0 left-[372px] px-4 py-3 invisible opacity-0 group-hover/childNike:visible group-hover/childNike:opacity-[1]"
    >
