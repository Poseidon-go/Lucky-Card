  ...
  return (
    ...
    >
      <div className="h-full w-[30%] bg-[#ECECEC] p-3">
        <ul className="">
          <li className="px-[10px] py-[15px] group rounded-[5px] hover:text-[--colorText] hover:bg-[--colorshophover] ">
          ...
          <li className="px-[10px] py-[15px] rounded-[5px] hover:text-[--colorText] hover:bg-[--colorshophover] ">
            <div className="flex justify-between font-semibold text-[#000] text-[16px]  ">
              Giày Nike
              <BiChevronRight />
            </div>
