  ...
  return (
    ...
    >
      <ul className="grid grid-cols-4 gap-0">
        <li className="group/li text-[--colorTextSub] font-semibold text-[16px] hover:text-[--colorshophover]">
          <span className="group-hover/:text-[--colorshophover]">
            Adidas Original
          </span>
          <ul className="py-3">
            <li>Stan Smith</li>
        ...
        <li className="text-[--colorTextSub] font-semibold text-[16px] hover:text-[--colorshophover]">
          Adidas UltraBoost
          <ul className="py-3">
