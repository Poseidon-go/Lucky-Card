    ...
    >
      <ul className="grid grid-cols-4 gap-0">
        <li className="text-[--colorTextSub] text-[16px]">
          <span className="font-bold text-inherit hover:text-[--colorshophover] transition duration-300 ease-in-out ">
            Adidas Original
          </span>
          <ul className="py-3 text-[14px] font-normal">
            <li className="hover:text-[--colorshophover] transition duration-300 ease-in-out ">
              Stan Smith
            </li>
            <li className="hover:text-[--colorshophover] transition duration-300 ease-in-out ">
              SuperStar
