    ...
    <div className=" bg-white shadow-lg ">
      <div className="w-pc mx-auto ">
        <ul className="relative flex items-center justify-center ">
          <li className="text-[#000] text-[16px] px-[15px] py-[10px] font-semibold hover:text-[--colorshophover] transition duration-500 ease-in-out ">
            Trang chủ
          </li>
          ...
          <li className="px-[15px] py-[10px] hover:text-[--colorshophover] text-[#000] text-[16px] ">
            <div className="flex items-center font-semibold text-inherit">
              Tính năng
              <BiChevronDown />
            </div>
