          ...
          <div id="footer__policy-introduce" className="flex w-3/6">
            <div className="w-4/6 mr-6">
              ...
              <ul className="pt-2">
                ...
                <li className="flex items-center text-[14px] py-1 text-wrap font-semibold hover:text-[--colorshophover] transition duration-300 ease-in-out ">
                  <LiaPhoneSolid className="font-semibold mr-1" />
                  0985449437
                </li>
                <li className="flex items-center text-[14px] pt-1 pb-2 text-wrap font-semibold hover:text-[--colorshophover] transition duration-300 ease-in-out">
            ...
            <div className="w-2/6">
              ...
              <ul className="list-disc pt-2">
                <li className="py-1 text-[14px] font-semibold hover:text-[--colorshophover] transition duration-300 ease-in-out">
                  Hệ thống cửa hàng
                </li>
                <li className="py-1 text-[14px] font-semibold hover:text-[--colorshophover] transition duration-300 ease-in-out">
                  Giới thiệu
