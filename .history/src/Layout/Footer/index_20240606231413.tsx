          ...
          <div id="footer__policy-introduce" className="flex w-3/6">
            <div className="w-3/6 mr-6">
              ...
              <ul>
                ...
                <li className="flex items-center justify-between text-[14px] py-1 text-wrap font-semibold ">
                  <LiaPhoneSolid className="font-semibold" />
                  0985449437
                </li>
                <li className="flex items-center text-[14px] py-1 text-wrap font-semibold">
                  <MdOutlineEmail className="font-semibold" />
                  duongoc79@gmail.com
                </li>
              </ul>
              <img
