  ...
  return (
    <footer className="bg-[--bgFooter] w-full  ">
      <div id="footer__wrap" className="w-pc mx-auto ">
        ...
        <div id="footer__policy" className="flex py-6 font-semibold">
          <div id="footer__policy-introduce" className="flex w-3/6">
            <div className="w-3/6 mr-6">
              <span className="text-[17px]">GIỚI THIỆU</span>
              <ul>
                <li className="text-[14px] py-1 text-wrap">
                  Wd Shoes Scofield chuyên cung cấp các loại giày authentic với
                  giá cả ưu đãi nhất thị trường
                </li>
                <li className="flex items-center">
                  <IoLocationOutline />
                  <span className="text-[14px] py-1 text-wrap">
                    432/24 Lạc Long Quân, Phường 5, Quận 11
                  </span>
                </li>
                <li className="flex items-center text-[14px] py-1 text-wrap ">
                  <LiaPhoneSolid />
                  0985449437
                </li>
                <li className="flex items-center text-[14px] py-1 text-wrap">
