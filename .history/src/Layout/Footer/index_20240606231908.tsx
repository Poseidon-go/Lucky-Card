          ...
          <div id="footer__policy-introduce" className="flex w-3/6">
            ...
            <div className="w-2/6">
              ...
              <ul className="list-disc">
                <li className="text-[14px] font-semibold">Hệ thống cửa hàng</li>
                <li className="text-[14px] font-semibold">Giới thiệu</li>
                ...
                <li className="text-[14px] font-semibold">Liên hệ</li>
              </ul>
            </div>
          </div>
          <div
